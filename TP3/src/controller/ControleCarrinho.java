...
public class ControleCarrinho {
	...
	public static void excluirEbook(Cliente cliente) {
		 ...
		 * for (Ebook edit : cliente.getCarrinho().getEbooks()) { // olha os ebooks do
		 * carrinho
		 * if (edit != null && edit.getNomeEbook().equals(opcaoString)) { // se o espaco
		 * nao for vazio efor igual ao
		 * // ebook selecionado
	...
	public static void esvaziarCarrinho(Cliente cliente) {
